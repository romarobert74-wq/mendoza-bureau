  ...
  return (
    ...
    >
      ...
      <div className="px-6 pt-8 pb-4 border-b border-white/10">
        {socio.fotoPortada && (
          <div
            className="w-full h-40 rounded-xl mb-4 bg-center bg-cover"
            style={{ backgroundImage: `url(${socio.fotoPortada})` }}
          />
        )}
        ...
        {socio.direccion && (
          <p className="text-white/50 text-sm mt-2">📍 {socio.direccion}</p>
        )}
      </div>
